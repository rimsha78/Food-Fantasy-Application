                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="container">
								  ...
								  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="margin-bottom: 20px;">Create New Student</button>
								          ...
								          <form action="datatable.php" method="Post" enctype="multipart/form-data">
											  ...
											  <div class="form-row">
											    <div class="form-group col-md-6">
											      ...
											      <input type="name" class="form-control" name="fname"  id="firstName" placeholder="First Name">
											    </div>
											    <div class="form-group col-md-6">
											      <label for="lastName">Last Name</label>
											      <input type="name" class="form-control"  name="lname" id="lastName" placeholder="Last Name">
											    </div>
											  </div>
											  <div class="form-row">
											    <div class="form-group col-md-6">
											      <label for="DOB">Date of Birth</label>
											      <input type="Date" class="form-control"  name="date_birth" id="DOB" placeholder="Date of Birth">
											    </div>
											    <div class="form-group col-md-6">
											  ...
											  <div class="form-row">
											    ...
											    <div class="form-group col-md-2">
											      ...
											      <input type="text" class="form-control"  name="code" id="inputZip" placeholder="Zip Code">
											    </div>
											  </div>
											  <div class="form-row">
